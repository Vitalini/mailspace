...
enum KeychainStore {
    static let service = "MailSpace"

    private static func baseQuery(for email: String) -> [String: Any] {
        [
    ...
    static func hasPassword(for email: String) -> Bool {
        password(for: email) != nil
    }

    @discardableResult
    static func setPassword(_ password: String, for email: String) -> Bool {
