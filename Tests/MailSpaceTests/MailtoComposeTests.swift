...
// Which account a `mailto:` is composed in moved to `ComposeRoutingTests` with
// the rule itself: `AppDelegate.mailtoAccount` is now
// `ComposeRouting.resolve(setting: .current, …)`.
